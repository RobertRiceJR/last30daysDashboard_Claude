...
def search_hackernews(
    ...
    # Algolia dropped `points` from the HN index's numericAttributesForFiltering
    # (~2026-06-17), so filtering points>2 in numericFilters now returns HTTP 400.
    # Apply the same quality bar client-side instead — each hit still carries `points`.
